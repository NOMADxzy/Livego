...
## Installation
After directly downloading the compiled [binary file](https://github.com/NOMADxzy/livego/releases), execute it on the command line.

#### Boot from Docker
Run `docker run -p 1935:1935 -p 7001:7001 -p 7002:7002 -p 8090:8090 -d NOMADxzy/livego` to start

#### Compile from source
1. Download the source code `git clone https://github.com/NOMADxzy/livego.git`
...
### [Use with flv.js](https://github.com/NOMADxzy/blog/issues/3)
